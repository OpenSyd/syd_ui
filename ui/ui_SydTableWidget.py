...
class Ui_SydTableWidget(object):
    def setupUi(self, SydTableWidget):
        ...
        self.label_tablename = QtWidgets.QLabel(SydTableWidget)
        self.label_tablename.setStyleSheet("color: rgb(0, 0, 255)")
        ...
        self.button_reload = QtWidgets.QPushButton(SydTableWidget)
        ...
        self.scrollAreaContent.setGeometry(QtCore.QRect(0, 0, 1040, 44))
    ...
    def retranslateUi(self, SydTableWidget):
        ...
        self.label_tablename.setText(QtWidgets.QApplication.translate("SydTableWidget", "TextLabel", None, -1))
        self.label.setText(QtWidgets.QApplication.translate("SydTableWidget", "Filter :", None, -1))
        self.button_reload.setText(QtWidgets.QApplication.translate("SydTableWidget", "reload", None, -1))
